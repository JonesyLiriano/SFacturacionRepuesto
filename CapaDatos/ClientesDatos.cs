...
namespace CapaDatos
{
    public class ClientesDatos
    {
        ...
        {
            modelDB.proc_InsertarCliente(clienteID,cliente.Nombre,cliente.CedulaORnc,cliente.Direccion,cliente.Contacto_1,cliente.Contacto_2,cliente.Descuento, cliente.Credito, resultado);
        ...
        {
            modelDB.proc_ActualizarCliente(cliente.ClienteID, cliente.Nombre, cliente.CedulaORnc, cliente.Direccion, cliente.Contacto_1, cliente.Contacto_2, cliente.Descuento, cliente.Credito, resultado);
