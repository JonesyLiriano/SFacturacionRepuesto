...
{
    public partial class ReporteFacturasCompra : Form
    {
        OrdenesCompraNegocio ordenesCompraNegocio = new OrdenesCompraNegocio();
        List<proc_CargarOrdenesCompraPFecha_Result> proc_CargarOrdenesCompraPFecha_Results;
        ...
        public ReporteFacturasCompra(DateTime fechaInicial, DateTime fechaFinal)
        {
            InitializeComponent();
            CargarParametros();
        ...
        private void CargarVistaPreviaRV(DateTime fechaInicial, DateTime fechaFinal)
        {
            try
            {
                proc_CargarOrdenesCompraPFecha_Results = ordenesCompraNegocio.CargarOrdenesCompraPFecha(fechaInicial, fechaFinal).ToList();
                var dataSource = new ReportDataSource("DataSetTodasFacturasCompra", proc_CargarOrdenesCompraPFecha_Results);
                reportViewer1.ProcessingMode = ProcessingMode.Local;
                reportViewer1.LocalReport.ReportPath = @"C:/SFacturacion/reporteFacturasCompra.rdlc";
